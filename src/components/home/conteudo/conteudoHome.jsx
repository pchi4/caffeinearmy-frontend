    ...
    return (
        <div>
            ...
            <div class="m-3 p-1 text-center">
                <h4 class="fw-bold"><img src="/icone_loja_roxo.svg" alt="icone roxo da loja" class="rounded-circle bg-info" className={style.iconCircle}></img> LOJA DE SUPLEMENTOS <span class="text-muted d-none d-sm-inline m-2">- LOJA DE SUPLEMENTOS LTDA.</span></h4>
            </div>
            <div >

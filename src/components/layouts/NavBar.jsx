        ...
        <ul class="nav nav-tabs ml-5 mr-5">
          <li class="nav-item text-center p-1">
            <a
              ...
              href="/home"
            >
              <img class="nav-link" alt="icone" src="/icone_lojas.svg"></img>
            </a>
            <a
          ...
          <li class="nav-item text-center p-1">
            <a
              class="fw-bold text-center text-dark text-decoration-none"
              onClick={Logout}
              href={() => false}
            >
              <img class="nav-link" alt="icone" src="/icone_sair.svg"></img>
            </a>
            <a
              class="fw-bold  d-none d-sm-block text-dark text-decoration-none"
              onClick={Logout}
              href={() => false}
            >
              <span id="logout" className={styles.logout}>
                Sair
              </span>
            </a>
          </li>
